...
const HIGH_IMPORTANCE = new Set([
  ...
  "US_ISM_NON_MANUFACTURING_PMI",
  "US_ISM_SERVICES",
  "US_EIA_CRUDE_OIL_INVENTORIES",
  "US_EIA_GASOLINE_INVENTORIES",
  "US_EIA_DISTILLATE_INVENTORIES",
  "US_EIA_CUSHING_CRUDE_INVENTORIES",
...
function inferBetterWhen(eventKey) {
  ...
  if (/EIA_.*INVENTOR/.test(key)) return "CONTEXTUAL";
