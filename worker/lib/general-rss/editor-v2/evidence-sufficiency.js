const MATERIAL_DEVELOPMENT_PATTERN =
  /\b(?:surge|jump|fall|drop|plunge|rally|selloff|decline|rise|gain|lose|slip|slips|hike|cut|hold|unchanged|beat|miss|guidance|earnings|revenue|profit|sanction|tariff|approval|decision|warns|announces|reports|confirms|escalat|threaten|impose|deal|vote|approve|deny|halt|suspend|resume|default|bankruptcy|ipo|merger|acquisition|liquidation|inflation|recession|cpi|ppi|nfp|gdp|pmi|fomc|payroll|jobless|expected|forecast|probability|odds|split|coin toss|await|speech|keynote|buyback|stablecoin|debuts|launches|worth|billion|million|percent|%\b|rate call|rate decision|central bank|fed chair|treasury yield|oil price|gold|bitcoin|crypto|dollar|yen|stocks?|sue|sues|struck|plans|investigate|raises|raise|hit|record|tanker|spacex|licensing|set the|reference rate|registration|orbit|satellite|crosshair|crosshairs|political group|licensing regime|cancels|cancel|softens|waking|catch up|underpaid|settlement|final hurdle|buying|toothless|clueless|backing|congressional|charter|trust bank|license application|counter tariffs?)\b|هبوط|ارتفاع|قرار|إعلان|تصعيد|عقوب|فائدة|أرباح|إيرادات/i;

const SUBJECT_PATTERN =
  /\b(?:bank|fed|ecb|boj|pboc|treasury|company|ceo|president|chair|minister|regulator|court|congress|parliament|analyst|investor|market|stock|bond|yield|oil|gold|bitcoin|crypto|dollar|yen|euro|nvidia|apple|meta|trump|iran|china|korea|japan|lakers|visa|mastercard|ford|spacex|sec|gemini|strategy|pakistan|comcast|charter|paramount|ellison|bessent|tanker|ukmto|political group|pboc|coinbase|solana|mstr|main street|situational awareness|toothless|clueless|zerohash|amd|intel|canada|layerzero)\b/i;
