...
export const FRAUD_SIGNAL_TYPES = Object.freeze({
  ...
  SAME_DEVICE_SAME_REFERRER: "same_device_same_referrer",
  SHARED_NETWORK_CLUSTER: "shared_network_cluster",
  SIGNUP_VELOCITY: "signup_velocity",
  SELF_REFERRAL_DEVICE: "self_referral_device",
  TEST_ACCOUNT_REWARD_ATTEMPT: "test_account_reward_attempt",
  E2E_ACCOUNT_REWARD_ATTEMPT: "e2e_account_reward_attempt",
  UNVERIFIED_REWARD_ATTEMPT: "unverified_reward_attempt",
