...
/** @deprecated Use BROWSER_SOUND_CHANNEL */
export const PRICE_ALERT_PUSH_CHANNEL = BROWSER_SOUND_CHANNEL;

/** @deprecated Use BROWSER_SOUND_MESSAGE_TYPE */
export const PRICE_ALERT_SOUND_MESSAGE_TYPE = "PRICE_ALERT_SOUND";
...
function isBrowserSoundMessage(data) {
  ...
  if (data.type === PRICE_ALERT_SOUND_MESSAGE_TYPE) return true;
