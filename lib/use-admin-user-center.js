...
export const USER_CENTER_TABS = [
  { id: "overview", label: "المعلومات", icon: "info" },
  { id: "services", label: "الخدمات", icon: "services" },
  { id: "subscriptions", label: "الاشتراكات", icon: "subscriptions" },
  { id: "payments", label: "إثباتات الدفع", icon: "payments" },
  { id: "activity", label: "النشاط", icon: "activity" },
  { id: "communications", label: "الإشعارات والبريد", icon: "communications" },
  { id: "notes", label: "الملاحظات", icon: "notes" },
  { id: "management", label: "الإدارة", icon: "management" },
];
