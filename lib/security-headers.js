...
export const SECURITY_HARDENING_NOTE =
  "Production CSP keeps unsafe-inline for theme boot and TradingView widget config injection. unsafe-eval removed after production verification. Server-only APIs (OpenAI/Resend) are excluded from connect-src. Set CSP_REPORT_ONLY=1 to test without enforcing.";
