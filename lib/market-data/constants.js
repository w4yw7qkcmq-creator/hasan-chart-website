...
export const LIQUIDITY_WALLS_SUMMARY_LIVE = "live";
export const LIQUIDITY_WALLS_SUMMARY_WINDOW_OPTIONS = [
...
export const DEFAULT_LIQUIDITY_WALLS_SUMMARY_WINDOW = LIQUIDITY_WALLS_SUMMARY_LIVE;
export const DEFAULT_LIQUIDITY_WALL_WINDOW = "7d";
