...
export const REGISTRY_FAILED_RETRY_MS = 45 * 1000;
export const REGISTRY_REFRESH_MAX_ATTEMPTS = 3;
export const REGISTRY_REFRESH_BACKOFF_MS = [1000, 3000, 8000];
export const REGISTRY_UNAVAILABLE_CACHE_MAX_AGE_SEC = 5;
export const CLIENT_REGISTRY_RETRY_MS = 45 * 1000;
...
export const EXCHANGE_FETCH_TIMEOUT_MS = 90_000;
