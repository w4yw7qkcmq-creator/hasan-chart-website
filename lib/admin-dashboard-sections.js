...
export const SUBSCRIPTION_LIST_SELECT_FIELDS =
  "id,user_email,username,plan_name,category,price,telegram_username,status,started_at,expires_at,created_at,admin_disabled,payment_proof_path,payment_proof";
