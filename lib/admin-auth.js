...
import { FALLBACK_ADMIN_EMAILS, isFallbackAdminEmail, normalizeEmail } from "./admin-emails";
...
export async function verifyAdminSession() {
  ...
  const isAdminByProfile = String(adminProfile?.role || "").trim() === "admin";
  const isAdminByFallback = isFallbackAdminEmail(normalizedEmail);
