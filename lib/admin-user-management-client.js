...
export async function fetchAdminUserList(
  ...
  const normalizedUserClassification = String(userClassification || "").trim().toLowerCase();
  if (normalizedUserClassification && normalizedUserClassification !== "all") {
    params.set("userClassification", normalizedUserClassification);
  }
