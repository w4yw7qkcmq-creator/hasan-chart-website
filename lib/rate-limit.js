...
/** SEC-004 — instant analysis abuse protection (before cooldown/reservation). */
export const instantAnalysisUserLimiter = createRateLimit({
  prefix: "instant-analysis-user",
  windowMs: TEN_MINUTES_MS,
  max: 6,
  useRedis: true,
});

export const instantAnalysisIpLimiter = createRateLimit({
  prefix: "instant-analysis-ip",
  windowMs: TEN_MINUTES_MS,
  max: 15,
  useRedis: true,
});
