  ...
  try {
    ...
    if (userEmail) {
      try {
        ...
        console.info("SUBSCRIPTION_REJECT_NOTIFICATION_RESULT", {
          requestId: normalizedRequestId,
          notificationCreated,
        });
      ...
      try {
        ...
        console.info("SUBSCRIPTION_REJECT_EMAIL_RESULT", {
          requestId: normalizedRequestId,
          emailQueued,
        });
      } catch (emailError) {
    ...
    try {
      ...
      console.info("SUBSCRIPTION_REJECT_AUDIT_RESULT", {
        requestId: normalizedRequestId,
        auditLogged,
      });
    } catch (auditError) {
      console.error("SUBSCRIPTION_REJECT_AUDIT_FAILED", {
        requestId: normalizedRequestId,
