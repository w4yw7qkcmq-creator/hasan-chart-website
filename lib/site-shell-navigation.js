...
export const PUBLIC_STATIC_BATCH_2_ROUTES = ["/markets", "/forex", "/crypto", "/stocks", "/economic-news"];

export const PUBLIC_STATIC_BATCH_3_ROUTES = ["/technical-analysis"];

export const PUBLIC_STATIC_MIGRATED_ROUTES = [
  ...PUBLIC_STATIC_BATCH_1_ROUTES,
  ...PUBLIC_STATIC_BATCH_2_ROUTES,
  ...PUBLIC_STATIC_BATCH_3_ROUTES,
];

export const PUBLIC_STATIC_REJECTED_BATCH_2_ROUTES = ["/price-alerts"];

export const PUBLIC_STATIC_REJECTED_BATCH_3_ROUTES = ["/price-alerts"];
