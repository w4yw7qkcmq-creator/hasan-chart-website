...
export const PUBLIC_STATIC_BATCH_3_ROUTES = ["/technical-analysis", "/price-alerts"];
...
export const PUBLIC_STATIC_REJECTED_BATCH_2_ROUTES = [];

export const PUBLIC_STATIC_REJECTED_BATCH_3_ROUTES = [];
