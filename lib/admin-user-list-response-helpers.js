...
export const ADMIN_USER_LIST_PROFILE_COLUMNS =
  "id,email,username,role,telegram,created_at,last_sign_in_at,subscription_plan,subscription_status,account_status,status_reason,status_updated_at,status_updated_by,suspended_at,banned_at,deleted_at";
