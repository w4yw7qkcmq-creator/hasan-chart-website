...
export const ROUTE_PERMISSIONS = Object.freeze({
  ...
  "GET /api/admin/email-outbox": IAM_PERMISSIONS.EMAIL_OUTBOX_READ,

  // Email campaigns (E2)
  "GET /api/admin/email-campaigns": IAM_PERMISSIONS.EMAIL_CAMPAIGN_READ,
  "POST /api/admin/email-campaigns": IAM_PERMISSIONS.EMAIL_CAMPAIGN_CREATE,
  "GET /api/admin/email-campaigns/audience-search": IAM_PERMISSIONS.EMAIL_CAMPAIGN_READ,
  "GET /api/admin/email-campaigns/[id]": IAM_PERMISSIONS.EMAIL_CAMPAIGN_READ,
  "PATCH /api/admin/email-campaigns/[id]": IAM_PERMISSIONS.EMAIL_CAMPAIGN_CREATE,
  "POST /api/admin/email-campaigns/[id]/audience": IAM_PERMISSIONS.EMAIL_CAMPAIGN_CREATE,
  "GET /api/admin/email-campaigns/[id]/preview": IAM_PERMISSIONS.EMAIL_CAMPAIGN_READ,
  "POST /api/admin/email-campaigns/[id]/test-send": IAM_PERMISSIONS.EMAIL_CAMPAIGN_SEND,
  "POST /api/admin/email-campaigns/[id]/launch": IAM_PERMISSIONS.EMAIL_CAMPAIGN_SEND,
  "POST /api/admin/email-campaigns/[id]/actions": IAM_PERMISSIONS.EMAIL_CAMPAIGN_SEND,
  "GET /api/admin/email-campaigns/audience-counts": IAM_PERMISSIONS.EMAIL_CAMPAIGN_READ,
  "GET /api/admin/email-analytics/marketing-metrics": IAM_PERMISSIONS.EMAIL_ANALYTICS_READ,
  ...
  "GET /api/admin/reconcile-profiles-last-sign-in": IAM_PERMISSIONS.SYSTEM_CRON_READ,
});
...
export const MACHINE_AUTH_ROUTES = Object.freeze([
  ...
  "GET /api/admin/reconcile-profiles-last-sign-in",
]);
