...
export const ADMIN_PAGE_PERMISSIONS = Object.freeze({
  ...
  "/admin/email-analytics/monitoring": IAM_PERMISSIONS.EMAIL_OUTBOX_READ,
  "/admin/email-analytics/compose": IAM_PERMISSIONS.EMAIL_CAMPAIGN_CREATE,
  "/admin/email-analytics/campaigns": IAM_PERMISSIONS.EMAIL_CAMPAIGN_READ,
  "/admin/email-analytics/campaigns/[id]": IAM_PERMISSIONS.EMAIL_CAMPAIGN_READ,
