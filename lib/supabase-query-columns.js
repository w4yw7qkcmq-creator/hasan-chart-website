...
export const NEWS_LIST_COLUMNS =
  "id,slug,title,normalized_title,content,impact_level,importance,priority,summary,description,ai_summary,created_at,image_url,image,thumbnail_url,thumbnail,urlToImage,url_to_image,media_url,source_image_url,og_image,cover_image,topic_cluster";

export const NEWS_ARTICLE_COLUMNS = NEWS_LIST_COLUMNS;

export const NEWS_RELATED_COLUMNS =
  "id,slug,title,normalized_title,content,created_at,topic_cluster,impact_level";
