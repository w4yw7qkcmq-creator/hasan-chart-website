...
/** Hub feed list — excludes heavy metadata blob. */
export const NOTIFICATION_HUB_FEED_COLUMNS =
  "id,user_email,title,message,type,notification_key,is_read,is_pinned,created_at,url";

export const NOTIFICATION_HUB_DETAIL_COLUMNS = NOTIFICATION_LIST_COLUMNS;
...
export const PARTNER_WITHDRAWAL_LIST_COLUMNS =
  "id,partner_id,amount,currency,network,wallet_address,status,created_at,paid_at,approved_at,rejected_at,updated_at";
...
export const EMAIL_MESSAGE_COLUMNS =
  "id,resend_id,outbox_id,recipient_email,subject,message_type,status,sent_at,created_at,delivered_at,failed_at,bounced_at,complained_at,opened,clicked,open_count,click_count,device,country,ip_address,opened_at,clicked_at,last_event_at,updated_at";

export const EMAIL_CAMPAIGN_LIST_COLUMNS =
  "id,name,status,subject,preview_text,eligible_count,queued_count,delivered_count,failed_count,bounced_count,complained_count,unsubscribed_count,created_at,updated_at,created_by,category,metadata";

export const EMAIL_MESSAGE_LIST_COLUMNS = EMAIL_MESSAGE_COLUMNS;

export const EMAIL_MESSAGE_CHART_COLUMNS =
  "sent_at,created_at,message_type,status,delivered_at,open_count,click_count,opened,clicked";
