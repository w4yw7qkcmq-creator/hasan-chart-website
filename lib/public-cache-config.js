...
/** Cached raw month/timestamp slices for archive sitemap generation (latest-ID filter applied at serve time). */
export const NEWS_SITEMAP_RAW_CACHE_SECONDS = 3600;
export const NEWS_API_CACHE_MS = 45_000;
export const NEWS_LIST_PAGE_SIZE = 20;
export const NEWS_LIST_MAX_PAGE_SIZE = 50;
/** Server-rendered news archive pagination page size — matches hub list density. */
export const NEWS_ARCHIVE_PAGE_SIZE = NEWS_LIST_PAGE_SIZE;
