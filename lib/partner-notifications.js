import { PARTNER_NOTIFICATION_INSERT_COLUMNS } from "./supabase-query-columns.js";
import { sendPartnerEmailHook } from "./partner-email-hooks.js";
...
export async function createPartnerNotification(
  ...
  const { data, error } = await supabase
    ...
    .select(PARTNER_NOTIFICATION_INSERT_COLUMNS)
    .single();
