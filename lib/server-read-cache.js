...
function getInFlightStore() {
  if (!globalForCache.__hcInFlightDedup) {
    globalForCache.__hcInFlightDedup = new Map();
  }
  return globalForCache.__hcInFlightDedup;
}

export async function withInFlightDedup(dedupKey, fetcher) {
