...
import { getVipSiteNotificationType, normalizeVipSignalType, signalTypeLabel } from "./vip-signal-types.js";
...
function buildPushOptionsForPreset(
  ...
  switch (preset) {
    ...
    case "vip_signal": {
      const signalType = normalizeVipSignalType(meta.signalType);
      const emailHash = normalizeEmailHash(userEmail);

      return {
        ...base,
        type: getVipSiteNotificationType(signalType),
        tag: meta.signalId
