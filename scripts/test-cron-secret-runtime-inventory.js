...
const RUNTIME_ALLOWLIST = new Map([
  ...
  ["worker/worker-security.js", "soak legacy fallback for worker HTTP routes"],
  ...
  ["scripts/iam/subscription-maintenance-production-audit.mjs", "production audit inventory only; classifies CRON_SECRET as rollback-only"],
  ["worker/subscription-maintenance-cron-caller.js", "cron caller logs legacy env presence only; never sends CRON_SECRET"],
