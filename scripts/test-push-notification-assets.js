...
assert.equal(WEB_PUSH_NOTIFICATION_BADGE, "/icons/notification-badge.png");
assert.equal(MAIN_WEBSITE_LOGO_PATH, "/favicon-192.png");
assert.equal(existsSync(join(ROOT, "public/favicon-192.png")), true);
assert.equal(existsSync(join(ROOT, "public/icons/notification-badge.png")), true);
...
assert.match(sw, /badge: "\/icons\/notification-badge\.png"/);
assert.match(sw, /payload\.badge \|\| "\/icons\/notification-badge\.png"/);
