        ...
        <section className="glassPanel p-8 md:p-10 overflow-hidden relative">
          ...
          <div className="relative grid lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-7 space-y-6">
              ...
              <h1 className="text-4xl md:text-6xl font-black leading-tight tracking-wide !text-white [text-shadow:0_4px_8px_rgba(0,0,0,0.85)]">
                منصة احترافية لمتابعة السوق وطلب التحليلات والتنبيهات السعرية
              </h1>

              <p className="text-lg font-bold leading-8 tracking-wide !text-white [text-shadow:0_3px_6px_rgba(0,0,0,0.82)]">
