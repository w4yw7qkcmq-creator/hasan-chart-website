...
const HomeLivePricesSection = dynamic(
  () =>
    import("../components/market/HomeLivePricesSection").then((mod) => mod.HomeLivePricesSection),
  {
    ssr: false,
    loading: () => (
...
const Service = memo(function Service({ title, text, href, publicLink = false, onRequireLogin }) {
  return (
    <button
      type="button"
      onClick={() => {
