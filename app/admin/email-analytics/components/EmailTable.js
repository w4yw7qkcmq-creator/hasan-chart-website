        ...
        <table className="min-w-[1200px] w-full text-right text-sm">
          <thead className="bg-slate-50/90 text-slate-600 dark:bg-black/20 dark:text-slate-300">
            <tr>
              ...
              <th className="px-4 py-4 font-black">Subject</th>
              ...
              <th className="px-4 py-4 font-black">Device</th>
          ...
          <tbody>
            {rows.map((row) => (
              ...
              >
                ...
                <td className="px-4 py-4 whitespace-nowrap font-medium text-slate-600 dark:text-slate-300">
                  {row.sentAtLabel}
                </td>
                <td className="px-4 py-4 whitespace-nowrap font-medium text-slate-600 dark:text-slate-300">
                  {row.openedAtLabel}
