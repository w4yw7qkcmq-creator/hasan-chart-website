...
import { validateHistoryFlowQuery } from "../../../../../lib/market-data/history/history-api-validation.js";
import {
...
export async function GET(request) {
  try {
    ...
    const validation = validateHistoryFlowQuery(new URL(request.url).searchParams);
    if (!validation.valid) {
      return jsonResponse(
    ...
    return jsonResponse(
      {
        success: false,
        error: "MARKET_HISTORY_FLOW_FAILED",
