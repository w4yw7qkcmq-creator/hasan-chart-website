...
import { createCampaignTiming } from "../../../../../../lib/email-campaign/timing.js";
import { invalidateShortLivedCache } from "../../../../../../lib/short-lived-cache.js";

export const dynamic = "force-dynamic";

export async function POST(request, { params }) {
  const timing = createCampaignTiming("prepare_audience");
  try {
    ...
    const timingReport = timing.finish({
      campaignId,
      recipientCount: result.recipientCount,
      eligible: result.stats?.eligible ?? 0,
    });
