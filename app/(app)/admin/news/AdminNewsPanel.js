...
export default function AdminNewsPanel() {
  ...
  return (
    <div className="admin-standalone-page admin-standalone-page--calm">
      ...
      {error ? (
        <div
          className="admin-news-page__alert admin-news-page__alert--error"
          role="alert"
          aria-live="assertive"
        >
          {" "}
      ...
      {message ? (
        <div
          className="admin-news-page__alert admin-news-page__alert--success"
          role="status"
          aria-live="polite"
        >
          {" "}
      ...
      <PermissionGate permission={IAM_PERMISSIONS.NEWS_READ}>
        {" "}
        <section
          className="admin-news-page__card"
