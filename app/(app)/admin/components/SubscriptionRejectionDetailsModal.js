...
export default function SubscriptionRejectionDetailsModal({ request, onClose }) {
  const titleId = useId();
  const dialogRef = useRef(null);
  const details = formatSubscriptionRejectionDetailsForAdmin(request?.rejectionDetails);
      ...
      >
        ...
        <div className="admin-crm-action-modal__body">
          <article className="admin-crm-action-modal__user-card">
            ...
            <div className="admin-crm-action-modal__user-row">
              <span className="admin-crm-action-modal__user-label">الباقة</span>
              <strong className="admin-crm-action-modal__user-value">
                {request.planName || "—"}
              </strong>
            </div>
          ...
          <article className="admin-subscription-rejection-details">
            <div className="admin-subscription-rejection-details__row">
              <span className="admin-subscription-rejection-details__label">سبب الرفض</span>
              <p className="admin-subscription-rejection-details__value">
                {details.rejectionReason}
              </p>
            </div>
            <div className="admin-subscription-rejection-details__row">
              <span className="admin-subscription-rejection-details__label">ملاحظات الإدارة</span>
              <p className="admin-subscription-rejection-details__value">
                {details.adminNotes}
              </p>
            </div>
            <div className="admin-subscription-rejection-details__row">
              <span className="admin-subscription-rejection-details__label">تاريخ الرفض</span>
              <p className="admin-subscription-rejection-details__value">{details.rejectedAt}</p>
            </div>
            <div className="admin-subscription-rejection-details__row">
              <span className="admin-subscription-rejection-details__label">نُفّذ بواسطة</span>
              <p className="admin-subscription-rejection-details__value">
                {details.rejectedByEmail}
              </p>
            </div>
            <div className="admin-subscription-rejection-details__row">
              <span className="admin-subscription-rejection-details__label">الإشعار الداخلي</span>
              <p className="admin-subscription-rejection-details__value">
                {details.notificationStatus}
              </p>
            </div>
            <div className="admin-subscription-rejection-details__row">
              <span className="admin-subscription-rejection-details__label">إيميل الرفض</span>
              <p className="admin-subscription-rejection-details__value">{details.emailStatus}</p>
            </div>
          </article>
        </div>
