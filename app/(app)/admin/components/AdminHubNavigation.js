    ...
    <section className="admin-hub-nav-section admin-section">
      ...
      <div className="admin-hub-section-head">
        ...
        <p className="admin-hub-section-head__desc">
          انتقل مباشرة إلى أي قسم — بطاقة كاملة قابلة للنقر.
        </p>{" "}
      </div>{" "}
      <div className="admin-hub-tile-grid">
        ...
        {navItems.map((item, index) => {
          ...
          const needsAttention =
            item.attentionKey && resolveStatValue(stats, item.attentionKey) > 0;
          const body = (
            <>
              {" "}
              ...
              <div className="admin-hub-tile__footer">
                {" "}
                {statValue !== null ? (
                  <p className="admin-hub-tile__value">
                    {statValue.toLocaleString("ar")}
                  </p>
                ) : (
                  <p className="admin-hub-tile__value admin-hub-tile__value--muted">
                    —
                  </p>
                )}{" "}
              ...
              {needsAttention ? (
                <span className="admin-hub-tile__flag">متابعة</span>
              ) : null}{" "}
