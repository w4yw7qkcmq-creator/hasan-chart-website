export const SUBSCRIPTIONS_HUB_LINKS = [
  ...
  { label: "VIP Forex", href: "/vip-forex" },
...
export const SUBSCRIPTION_PLANS = [
  ...
  },
  {
    ...
    badge: "Forex",
    features: [
      "توصيات فوركس لمدة شهر",
      "متابعة أزواج العملات الرئيسية",
      "إدارة مخاطر أساسية",
      "تنبيهات دخول وخروج",
    ],
  },
  {
    ...
    period: "/ثلاثة أشهر",
    icon: "📊",
    glow: "from-teal-500/30 to-emerald-400/10",
    badge: "Forex Plus",
    featured: true,
    features: [
      "توصيات فوركس لمدة 3 أشهر",
      "متابعة مستمرة للصفقات",
      "إدارة مخاطر احترافية",
      "دعم مباشر مع الفريق",
    ],
  },
  {
    ...
    period: "/سنة",
    icon: "👑",
    glow: "from-teal-600/30 to-emerald-400/10",
    badge: "Forex VIP",
    features: [
      "توصيات فوركس لمدة سنة كاملة",
      "متابعة احترافية للصفقات",
      "خطة إدارة مخاطر متقدمة",
      "أولوية كاملة بالدعم الفني",
    ],
