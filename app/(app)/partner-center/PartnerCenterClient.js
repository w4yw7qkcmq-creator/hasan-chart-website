...
function PartnerCenterAuthenticated() {
  const { showAppModal } = useAppModal();
  const { sessionPending, isAuthenticated } = useRequireAuth();
...
export default function PartnerCenterClient({ landing, initialAuthenticated = false }) {
  return (
    <RequireAuthGuestLandingGate landing={landing} initialAuthenticated={initialAuthenticated}>
      <PartnerCenterAuthenticated />
