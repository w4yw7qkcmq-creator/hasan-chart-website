...
const PartnerQrCode = dynamic(
  () =>
    import("../../components/partner/PartnerQrCode").then(
      (mod) => mod.PartnerQrCode,
    ),
  { ssr: false },
);
...
const PartnerRewardsPanel = dynamic(
  () =>
    import("../../components/partner/PartnerRewardsPanel").then(
      (mod) => mod.PartnerRewardsPanel,
    ),
  { ssr: false },
);
      ...
      <header className="user-dashboard-hero">
        ...
        <div>
          ...
          <p className="user-dashboard-hero__subtitle">
            {" "}
            شارك رابط الإحالة الخاص بك وتابع الزيارات والتسجيلات والأرباح من
            مكان واحد.{" "}
          </p>{" "}
        </div>{" "}
      </header>{" "}
      {loading ? (
        ...
        <>
            ...
            <div className="grid gap-6 lg:grid-cols-2">
              ...
              <div className="partner-surface partner-surface--p5">
                ...
                <p className="partner-accent-green">
                  {" "}
                  نسبة العمولة:{" "}
                  {tierProgress?.commissionPercent ??
                ...
                {tierProgress?.tierUpdatedAt ? (
                  <p className="partner-muted--sm mt-2">
                    {" "}
                    آخر تحديث للمستوى:{" "}
                    {formatDate(tierProgress.tierUpdatedAt)}{" "}
                  </p>
                ) : null}{" "}
              </div>{" "}
              {tierProgress?.nextTier ? (
                <div className="partner-surface partner-surface--p5">
                  ...
                  <p className="partner-label">
                    {" "}
                    التقدم نحو {tierProgress.nextTier.tierName} (
                    {tierProgress.nextTier.commissionPercent}%){" "}
                  </p>{" "}
                  <div className="partner-progress">
                    ...
                    <div className="partner-progress">
                      ...
                      <div className="partner-progress__head">
                        ...
                        <span>
                          {" "}
                          {tierProgress.activeReferrals} /{" "}
                          {tierProgress.nextTier.minActiveReferrals}{" "}
                        </span>{" "}
                      </div>{" "}
                      <div className="partner-progress__track">
                        ...
                        <div
                          ...
                          style={{
                            width: `${tierProgress.nextTier.activeReferralsProgress}%`,
                          }}
                        />{" "}
                      </div>{" "}
                    </div>{" "}
                    <div className="partner-progress">
                      ...
                      <div className="partner-progress__head">
                        ...
                        <span>
                          ...
                          {formatPartnerMoney(
                            tierProgress.nextTier.minTotalSales,
                          )}{" "}
                        </span>{" "}
                      </div>{" "}
                      <div className="partner-progress__track">
                        ...
                        <div
                          ...
                          style={{
                            width: `${tierProgress.nextTier.totalSalesProgress}%`,
                          }}
                        />{" "}
                      </div>{" "}
                    </div>{" "}
                    <p className="partner-progress__hint">
                      {" "}
                      شروط المستوى التالي:{" "}
                      {tierProgress.nextTier.minActiveReferrals} حساب نشط على
                      الأقل و
                ...
                <div className="partner-surface partner-surface--p5 partner-surface--success">
                  {" "}
                  <p className="partner-accent-success-title">
                    أعلى مستوى — Diamond
                  </p>{" "}
            ...
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
              ...
              <MetricCard
                ...
                value={formatPartnerMoney(
                  wallet?.balanceWithdrawable ?? partner.balanceWithdrawable,
                )}
                icon="💵"
                tone="green"
              />{" "}
              <MetricCard
                title="الرصيد المعلق"
                value={formatPartnerMoney(
                  wallet?.balancePending ?? partner.balancePending,
                )}
                icon="⏳"
                tone="blue"
              />{" "}
              <MetricCard
                ...
                value={formatPartnerMoney(
                  wallet?.balanceBonusPending ?? partner.balanceBonusPending,
                )}
                icon="🎁"
                tone="cyan"
              />{" "}
              <MetricCard
                ...
                value={formatPartnerMoney(
                  wallet?.totalEarnings ?? partner.totalEarnings,
                )}
                icon="💰"
                tone="gold"
              />{" "}
            ...
            {wallet?.lastWithdrawal ? (
              <div className="partner-surface partner-surface--p4 partner-wallet-note mt-4">
                ...
                <p className="partner-wallet-note__title">
                  {" "}
                  حالة آخر طلب:{" "}
                  {withdrawalStatusLabel(wallet.lastWithdrawalStatus)}{" "}
                </p>{" "}
                <p className="partner-wallet-note__meta">
                  {" "}
                  {wallet.lastWithdrawal.network} ·{" "}
                  {formatDate(wallet.lastWithdrawal.createdAt)}{" "}
          ...
          <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            {" "}
            <MetricCard
              title="مشتركو VIP Signals"
              value={partner.vipSignalCount ?? 0}
              icon="⭐"
              tone="blue"
            />{" "}
            <MetricCard
              title="VIP Spot"
              value={partner.vipSpotCount ?? 0}
              icon="📈"
              tone="cyan"
            />{" "}
            <MetricCard
          ...
          <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            ...
            <MetricCard
              ...
              value={formatPartnerMoney(
                partner.withdrawableCommissionsAmount ?? 0,
              )}
              icon="💵"
              tone="green"
            />{" "}
          ...
          <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            ...
            <MetricCard
              title="عدد الزيارات"
              value={partner.visitCount}
              icon="👁️"
              tone="blue"
            />{" "}
            <MetricCard
              title="عدد المسجلين"
              value={partner.signupCount}
              icon="📝"
              tone="cyan"
            />{" "}
            <MetricCard
          ...
          <Panel
            title="رابط الإحالة"
            subtitle="شارك هذا الرابط — الزائر يرى الصفحة الرئيسية بشكل طبيعي"
          >
            {" "}
            <div className="grid gap-6 lg:grid-cols-[1fr_auto]">
              ...
              <div className="space-y-4">
                ...
                <div>
                  {" "}
                  <label className="partner-label mb-2 block">
                    كود الإحالة
                  </label>{" "}
                  <input
                    type="text"
          ...
          <Panel
            title="سجل الإحالات"
            subtitle="المستخدمون الذين سجّلوا عبر رابطك"
          >
            {" "}
          ...
          <Panel
            title="سجل العمولات"
            subtitle="تفاصيل كل عمولة: الخدمة، السبب، النسبة، المبلغ، الحالة، والتاريخ"
          >
            {" "}
                ...
                {data.commissions.map((item) => (
                  <article key={item.id} className="user-dashboard-list-item">
                    ...
                    <div className="user-dashboard-list-item__head">
                      ...
                      <span
                        className={`user-dashboard-badge ${item.status === "withdrawable" || item.is_withdrawable ? "user-dashboard-badge--done" : "user-dashboard-badge--active"}`}
                      >
                        {" "}
                        {statusLabel(item.status)}{" "}
                      </span>{" "}
            ...
            <div className="space-y-4">
              ...
              {!canRequestWithdrawal ? (
                <div className="partner-alert-warn">
                  ...
                  {(wallet?.balanceWithdrawable ??
                    partner.balanceWithdrawable ??
                    0) < MIN_PARTNER_WITHDRAWAL_USDT
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="partner-input-hint">
                      {" "}
                      الحد الأدنى: {MIN_PARTNER_WITHDRAWAL_USDT} USDT · الحد
                      الأقصى:{" "}
                      {formatPartnerMoney(
                        wallet?.balanceWithdrawable ??
                          partner.balanceWithdrawable,
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        setWithdrawWallet(event.target.value)
                      }
                      required
                      className="partner-input partner-input--mono"
              ...
              {data.withdrawals?.length ? (
                <div className="partner-divider">
                  {" "}
                  <h3 className="partner-divider__title">
                    طلبات السحب السابقة
                  </h3>{" "}
                  <div className="partner-scroll-panel partner-scroll-panel--list mt-3 space-y-3">
                    ...
                    {data.withdrawals.map((item) => (
                      <article
                        key={item.id}
                        className="user-dashboard-list-item"
                      >
                        {" "}
                        <div className="user-dashboard-list-item__head">
                          {" "}
