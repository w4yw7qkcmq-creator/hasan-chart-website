...
export function UiModal({
  ...
  return (
    <UiPortal>
      <div className={ui.modalScrim} onClick={handleBackdropClick} role="presentation">
        <div
        ...
        >
          ...
          {title ? (
            <h3 id="ui-modal-title" className="text-3xl font-black leading-relaxed ui-text-strong">
              {title}
            </h3>
          ) : null}
          {message ? (
            <p id="ui-modal-message" className="mx-auto mt-4 max-w-sm whitespace-pre-line text-lg font-bold leading-9 ui-text-muted">
              {message}
            </p>
          ) : null}
          {mode === "confirm" ? (
