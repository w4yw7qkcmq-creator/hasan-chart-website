...
export function NotificationHubList({
  ...
  if (!useVirtual) {
    return (
      <div ref={parentRef} className="notificationHubList">
        ...
        <div
          ref={sentinelRef}
          className="notificationHubList__sentinel"
          aria-hidden="true"
        />{" "}
        {loadingMore ? (
          <p className="notificationHubList__loadingMore">
            جاري تحميل المزيد...
          </p>
        ) : null}{" "}
      </div>
  ...
  return (
    <div
      ref={parentRef}
      className="notificationHubList notificationHubList--virtual"
    >
      {" "}
      <div
      ...
      />{" "}
      {loadingMore ? (
        <p className="notificationHubList__loadingMore">جاري تحميل المزيد...</p>
      ) : null}{" "}
    </div>
  );
}
