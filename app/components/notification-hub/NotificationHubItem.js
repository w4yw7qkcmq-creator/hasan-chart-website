...
export function NotificationHubItem({
  ...
  return (
    <article
      ...
      className={`notificationHubItem ${notification.isRead ? "notificationHubItem--read" : "notificationHubItem--unread"} ${
        notification.isPinned ? "notificationHubItem--pinned" : ""
      }`}
      style={{ "--hub-accent": notification.hubColor || "#22d3ee" }}
    >
      ...
      <div className="notificationHubItem__body">
        <div className="notificationHubItem__header">
          <div
            className="notificationHubItem__icon"
            aria-hidden="true"
          >
          ...
          <div className="notificationHubItem__meta">
            <div className="notificationHubItem__titleRow">
              <p className="notificationHubItem__title">{notification.displayTitle}</p>
              {!notification.isRead ? (
            ...
            <div className="notificationHubItem__badges">
              <span className="notificationHubItem__badge">{notification.hubBadge}</span>
