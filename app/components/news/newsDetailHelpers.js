...
const TOPIC_TYPE_RULES = [
  {
    pattern: /inflation|cpi|pce|تضخم/i,
    label: "أخبار التضخم",
    watchTopic: "inflation",
  },
  {
  ...
  {
    pattern:
      /bitcoin|btc|crypto|ethereum|blockchain|بيتكوين|كريبتو|عملات رقمية/i,
  ...
  inflation: [
    {
      ...
      href: "/dxy",
      note: "تأثر قوة الدولار ببيانات التضخم",
    },
    { label: "الذهب", href: "/xau", note: "ملاذ آمن يتأثر بتوقعات الفائدة" },
    {
      label: "المؤشرات العالمية",
      href: "/stocks",
      note: "معنويات المخاطرة في الأسواق",
    },
  ...
  rates: [
    {
      label: "الدولار الأمريكي",
      href: "/dxy",
      note: "أول استجابة لقرارات وإشارات الفائدة",
    },
    { label: "الذهب", href: "/xau", note: "يتأثر بمسار العائد والدولار" },
    {
      label: "الأسهم العالمية",
      href: "/stocks",
      note: "تقييم المخاطرة وتكلفة التمويل",
    },
    {
      label: "العملات الرقمية",
      href: "/crypto",
      note: "تدفقات السيولة والمخاطرة",
    },
  ],
  oil: [
    { label: "USOIL", href: "/usoil", note: "الأصل الأقرب مباشرة لخبر النفط" },
    {
      label: "الذهب",
      href: "/xau",
      note: "ارتباط السلع والتوترات الجيوسياسية",
    },
...
} /** * @param {Record<string, unknown>} news * @param {string} category */
...
} /** * @param {Array<{ symbol: string, name: string }>} relatedAssets * @param {string} category */
export function getAffectedMarketLabel(
  relatedAssets = [],
  category = "markets",
) {
