    ...
    >
      ...
      {theme.isUrgent ? (
        <div className="news-fallback-cover__top">
          <span className="news-fallback-cover__badge news-fallback-cover__badge--urgent">عاجل</span>
        </div>
      ) : null}
      ...
      <div className="news-fallback-cover__footer">
        <span className="news-fallback-cover__category">{theme.categoryLabel}</span>
      </div>
    </div>
  );
}
