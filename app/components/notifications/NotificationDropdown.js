...
export function NotificationDropdown({ open, onClose, anchorRef }) {
  ...
  return (
    <div
      ref={panelRef}
      className={`notificationDropdown fixed left-4 top-20 z-[120] w-[min(100vw-2rem,24rem)] overflow-hidden rounded-[28px] border p-4 shadow-[0_24px_80px_rgba(0,102,255,0.22)] backdrop-blur-2xl sm:left-5 sm:top-24 ${open ? "notificationDropdown--open" : "notificationDropdown--closed"}`}
      aria-hidden={!open}
    >
      {" "}
      ...
      <div className="relative z-10 mb-3 flex items-center justify-between gap-3">
        ...
        <div>
          {" "}
          <h3 className="notificationDropdown__title font-black text-lg">
            الإشعارات
          </h3>{" "}
